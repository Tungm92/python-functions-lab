...
def convert_temperature(unit, temperature):
    if temperature == 'C':
        ...
        print(f'parameters in valid. Please try again.')
...
print('Exercise 6:', largest(3, 5, 4))
print('Exercise 6:', largest(3, 5, 5))
print('Exercise 6:', largest(6, 6, 4))
print('Exercise 6:', largest(2, 2, 2))
...
def basicCalculator(a, b, operation):
    if 'add' in operation:
        ...
        print(f'Operation unclear. Please try again.')
